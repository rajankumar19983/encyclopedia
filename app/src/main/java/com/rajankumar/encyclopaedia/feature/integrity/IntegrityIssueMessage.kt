...
fun IntegrityIssue.message(): String = when (this) {
  ...
  IntegrityIssue.IDS -> "One or more backup records have blank or duplicate identifiers."
  IntegrityIssue.FIELDS -> "One or more backup records contain invalid required fields."
