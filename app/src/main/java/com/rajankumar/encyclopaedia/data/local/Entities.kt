...
data class KnowledgeNodeEntity(@PrimaryKey val id: String, val parentId: String?, val name: String, val description: String? = null, val sortOrder: Int = 0, val isArchived: Boolean = false, @ColumnInfo(defaultValue = "'USER'") val source: String = KnowledgeContentSource.USER, val createdAt: Long = System.currentTimeMillis(), val updatedAt: Long = System.currentTimeMillis())
...
data class LessonEntity(@PrimaryKey val id: String, val knowledgeNodeId: String, val title: String, val content: String, val sortOrder: Int = 0, val isArchived: Boolean = false, @ColumnInfo(defaultValue = "'USER'") val source: String = KnowledgeContentSource.USER, val createdAt: Long = System.currentTimeMillis(), val updatedAt: Long = System.currentTimeMillis())
