...
class PlannerCapacityTest {
  @Test fun suggestsRoomBelowTarget() {
  ...
  @Test fun carriedBacklogBlocksAdditionalPlanning() {
  ...
  @Test fun negativeTargetCannotSuggestNegativeCapacity() = assertEquals(0, emptyList<PlannerTaskEntity>().plannerCapacity(-5).suggestedAdditionalTasks)
}
